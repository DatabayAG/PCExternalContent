...
/**
 * Page Component External Content plugin: saved value
 *
 * @author Jesus Copado <jesus.copado@fau.de>
 * @version $Id$
 */
class ilPCExternalContentValue
{
	/**
	 * @var integer the obj_id of the Page Component Object
	 */
	public $obj_id;
	...
	public function save()
	{
		...
		if (empty($this->title) or empty($this->type_id) or empty($this->obj_id))
		{
			return false;
		}
		if (!isset($this->id))
